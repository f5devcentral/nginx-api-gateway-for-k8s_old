...
The `jobs-openapi-spec.yaml <https://raw.githubusercontent.com/f5devcentral/nginx-api-gateway-for-k8s/main/task_04/jobs-openapi-spec.yaml>`_ is hosted on GitHub.
